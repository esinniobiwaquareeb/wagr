        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              By accessing and using wagered.app, you accept and agree to be bound by the terms and provision of this agreement.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Permission is granted to temporarily use wagered.app for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>Modify or copy the materials</li>
              <li>Use the materials for any commercial purpose or for any public display</li>
              <li>Attempt to reverse engineer any software contained on wagered.app</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              By participating in wagers on wagered.app, you acknowledge that:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify wagered.app immediately of any unauthorized use of your account.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li>Use wagered.app for any illegal purpose</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              wagered.app shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              wagered.app reserves the right to modify these terms at any time. We will notify users of any material changes. Your continued use of the service after changes constitutes acceptance of the new terms.
            </p>
          </section>
