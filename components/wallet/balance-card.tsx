...
export function BalanceCard({ balance, currency, currencySymbol }: BalanceCardProps) {
  return (
      ...
      <CardContent className="p-6 md:p-8">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">{formatCurrency(balance, currency, currencySymbol)}</h2>
          </div>
