      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 ml-3">
          ...
          <button
            ...
            className={`relative flex items-center justify-center w-10 h-10 rounded-lg text-sm font-medium transition-all ${
              hasActiveFilters
          ...
          >
            ...
            {filterCount > 0 && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full border-2 border-background flex items-center justify-center">
                <span className="text-[8px] font-bold text-white">{filterCount}</span>
              </span>
            )}
          </button>
        </div>
